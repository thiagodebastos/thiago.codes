...
import { sanitizeString } from './saninize-string'
import { checkElementsAgainstArray } from './check-array-includes-elements'
...
describe('multiFilter', () => {
  ...
  const filters = {
    ...
    tags: (tags) =>
      !!tags
        ? checkElementsAgainstArray({ array: tags, elements: searchTags })
        : true,
  }
